...
public class SoundBoardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SoundObject[] soundItems = {
                ...
                new SoundObject(nameList.get(32), R.raw.canttie),
                new SoundObject(nameList.get(33), R.raw.thuglife),
                new SoundObject(nameList.get(34), R.raw.mlgvoice),
                new SoundObject(nameList.get(35), R.raw.nice),
                new SoundObject(nameList.get(36), R.raw.nonigga),
                new SoundObject(nameList.get(37), R.raw.thatsracist),
                new SoundObject(nameList.get(38), R.raw.thuglifeeffect),
                new SoundObject(nameList.get(39), R.raw.thuglifeeffect2),
                new SoundObject(nameList.get(40), R.raw.universalmlg),
                new SoundObject(nameList.get(41), R.raw.watchur),
                new SoundObject(nameList.get(42), R.raw.whatrthose),
                new SoundObject(nameList.get(43), R.raw.whyyou),
